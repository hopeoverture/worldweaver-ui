...
import type { World, Entity, Folder, Template } from '../types';
import type { Relationship } from '../supabase/types';
...
class UnifiedService {
  ...
  async createRelationship(worldId: string, data: Partial<Relationship> & { fromEntityId: string; toEntityId: string; relationshipType: string }, userId: string) { return supabaseWorldService.createRelationship(worldId, data, userId); }
