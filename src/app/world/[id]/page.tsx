...
export default function WorldDashboard() {
  ...
  const tabs: TabItem[] = [
    ...
    },
    {
      ...
      count: 0, // Will be replaced with actual map count when implemented
      render: (
        <Suspense fallback={<SkeletonLoader type="maps" message="Loading maps..." />}>
          <MapsTab worldId={strWorldId} />
        </Suspense>
      ),
    },
    {
